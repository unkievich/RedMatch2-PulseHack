...
enum ImGuiSliderFlags_
{
    ...
    ImGuiSliderFlags_Integer                = 1 << 22,      // Compatibility flag used by custom widgets to distinguish integer knobs.
...
enum ImDrawFlags_
{
    ...
    ImDrawFlags_ShadowCutOutShapeBackground = 1 << 9, // Compatibility flag for custom shadow helpers.
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRectFilledMultiColor(const ImVec2& p_min, const ImVec2& p_max, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding, ImDrawFlags flags = 0);
    ...
    IMGUI_API void  AddShadowConvexPoly(const ImVec2* points, int points_count, ImU32 shadow_col, float shadow_thickness, const ImVec2& shadow_offset);
