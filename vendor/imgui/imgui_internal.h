...
#define ImGuiNavHighlightFlags_TypeThin ImGuiNavHighlightFlags_Compact
#endif
...
//#endif
    ...
    inline float            GetAnimSpeed()
    {
        return ImMin(GetIO().DeltaTime * 12.0f, 1.0f);
    }
    inline ImU32            GetColorU32(const ImVec4& col, float alpha_mul)
    {
        ImVec4 col_with_alpha = col;
        col_with_alpha.w = alpha_mul;
        return ColorConvertFloat4ToU32(col_with_alpha);
    }
